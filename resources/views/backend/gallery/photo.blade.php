...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <button class="btn btn-danger btn-sm" style="float: right;" data-toggle="modal" data-target="#modal-default">Add Photo</button>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="{{route('store.photo')}}" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control " id="english" name="photo">
