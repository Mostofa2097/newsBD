            ...
            <div class="modal-body">
              ...
              <form method="POST" action="{{route('update.district',$district->id)}}">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" value="{{$district->district_bn}}" aria-describedby="emailHelp" name="district_bn">
                 
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">district Namke English</label>
                  <input type="text" class="form-control " value="{{$district->district_en}}"  name="district_en">
